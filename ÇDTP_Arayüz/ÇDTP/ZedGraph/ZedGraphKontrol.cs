...
namespace ÇDTP.ZedGraph
{
    public class ZedGraphKontrol : ZedGraphControl
    {
        ...
        bool HizliOlcekleme;
        public PointPairListBase VeriListesi { get; } = new PointPairListBase(VeriTuru.Single);
        LineItem Grafik;
        bool _GecmisiIncele;
        ...
        {
            GraphPane.Title.Text = "Daire " + GrafikNumarasi + " Anlık Güç Grafiği";
            ...
            Grafik = GraphPane.AddCurve("Veri " + GrafikNumarasi, VeriListesi, Color.Black);
            VeriListesi.Add(VeriListesi.BaslangicZamani, 46.875);
        }
